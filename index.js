...
const SUB_PATH = process.env.SUB_PATH || '1660';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || 'a7eed207-3d5b-4d2f-bf3d-de350a757af8'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'wt0888';                        // 节点名称
